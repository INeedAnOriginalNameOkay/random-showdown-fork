...
//	},
	pikachu: {
		...
		abilities: { 0: "Static", 1: "Transistor", H: "Lightning Rod" },
		heightm: 0.4,
		weightkg: 6,
		color: "Yellow",
		prevo: "Pichu",
...
//	},
	onix: {
		...
		color: "Gray",
		evos: ["Steelix"],
		otherFormes: ["Onix-Banerica"],
		formeOrder: ["Onix", "Onix-Banerica"],
		eggGroups: ["Mineral"],
	},
	onixbanerica: {
		num: 95,
		...
		baseStats: { hp: 35, atk: 85, def: 100, spa: 30, spd: 45, spe: 90 },
		abilities: { 0: "Rock Head", 1: "Sturdy", H: "Weak Armor" },
		heightm: 8.8,
		weightkg: 408.2,
		color: "Gray",
...
//	},
	...
	koffing: {
		...
		otherFormes: ["Koffing-Banerica"],
		formeOrder: ["Koffing", "Koffing-Banerica"],
		eggGroups: ["Amorphous"],
	},
//	//banerican koffing
	koffingbanerica: {
...
//	//banerican weezing
	weezingbanericacute: {
		num: 110,
		name: "Weezing-Banerica-Cute",
		baseSpecies: "Weezing",
		forme: "Banerica",
		types: ["Fairy"],
		baseStats: { hp: 65, atk: 90, def: 120, spa: 85, spd: 70, spe: 60 },
		abilities: { 0: "Two-Faced", 1: "Neutralizing Gas", H: "Levitate" },
		heightm: 1.2,
		weightkg: 7.6,
		color: "Pink",
		prevo: "Koffing-Banerica",
		evoLevel: 35,
		eggGroups: ["Amorphous","Fairy"],
	...
	weezingbanericascary: {
		num: 110,
		name: "Weezing-Banerica-Scary",
		baseSpecies: "Weezing",
		forme: "Banerica-Scary",
		types: ["Dark"],
...
//	},
	...
	dratinibanerica: {
		num: 147,
		name: "Dratini-Banerica",
	   baseSpecies: "Dratini",
		forme: "Banerica",
		types: ["Dragon", "Ice"],
		baseStats: { hp: 41, atk: 50, def: 45, spa: 64, spd: 50, spe: 50 },
		abilities: { 0: "Shed Skin", H: "Ice Scales" },
		heightm: 1.8,
		weightkg: 3.3,
		color: "Blue",
		evos: ["Dragonair-Banerica"],
		nfe: true,
		eggGroups: ["Water 1", "Dragon"],
	},
	dragonair: {
	...
	dragonairbanerica: {
		num: 148,
		name: "Dragonair-Banerica",
		baseSpecies: "Dragonair",
		forme: "Banerica",
		types: ["Dragon"],
		baseStats: { hp: 61, atk: 70, def: 65, spa: 84, spd: 70, spe: 70 },
		abilities: { 0: "Shed Skin", H: "Ice Scales" },
		heightm: 4,
		weightkg: 16.5,
		color: "Blue",
		prevo:"Dratini-Banerica",
		evoLevel: 30,
		evos: ["Dragonyrm"],
		nfe: true,
		eggGroups: ["Water 1", "Dragon"],
...
//	},
	chinchou: {
		...
		abilities: { 0: "Storm Drain", 1: "Illuminate", H: "Stormborne" },
		heightm: 0.5,
		weightkg: 12,
		color: "Blue",
		evos: ["Lanturn"],
...
//	},
	mareep: {
		...
		abilities: { 0: "Static", 1: "Electromorphosis", H: "Plus" },
		heightm: 0.6,
		weightkg: 7.8,
		color: "White",
		evos: ["Flaaffy"],
	...
	ampharos: {
		...
		name: "Ampharos",
		types: ["Electric"],
		baseStats: { hp: 100, atk: 65, def: 85, spa: 115, spd: 90, spe: 55 },
		abilities: { 0: "Static", 1: "Electromorphosis", H: "Plus" },
		heightm: 1.4,
		weightkg: 61.5,
		color: "Yellow",
...
//	},
	sneasel: {
		...
		evos: ["Weavile"],
		eggGroups: ["Field"],
		otherFormes: ["Sneasel-Hisui", "Sneasel-Banerica"],
		formeOrder: ["Sneasel", "Sneasel-Hisui","Sneasel-Banerica"],
	},
	sneaselhisui: {
		num: 215,
		name: "Sneasel-Hisui",
	...
	sneaselbanerica: {
		...
		baseSpecies: "Sneasel",
		types: ["Ghost", "Ice"],
		baseStats: { hp: 55, atk: 105, def: 45, spa: 40, spd: 70, spe: 115 },
		abilities: { 0: "Inner Focus", 1: "Vital Spirit", H: "Pickpocket" },
		heightm: 0.9,
		weightkg: 28,
		color: "Black",
		evos: ["Sneasless"],
	...
	*/
	...
	houndoom: {
		...
		abilities: { 0: "Dark Aura", 1: "Flash Fire", H: "Unnerve" },
		heightm: 1.4,
		weightkg: 35,
		color: "Black",
		prevo: "Houndour",
...
//	},
	zigzagoon: {
		...
		formeOrder: ["Zigzagoon", "Zigzagoon-Galar", "Zigzagoon-Banerica"],
	},
//	zigzagoongalar: {
//		num: 263,
...
//	},
	...
	linoone: {
		...
		formeOrder: ["Linoone", "Linoone-Galar", "Linoone-Banerica"],
	},
//	linoonegalar: {
//		num: 264,
//		name: "Linoone-Galar",
...
//	},
	whismur: {
		...
		abilities: { 0: "Soundproof", 1: "Equalizer", H: "Rattled" },
		heightm: 0.6,
		weightkg: 16.3,
		color: "Pink",
		evos: ["Loudred"],
	...
	loudred: {
		...
		abilities: { 0: "Soundproof", 1: "Equalizer", H: "Scrappy" },
		heightm: 1,
		weightkg: 40.5,
		color: "Blue",
		prevo: "Whismur",
...
//	},
	...
	skitty: {
		...
		evos: ["Delcatty"],
		eggGroups: ["Field", "Fairy"],
		otherFormes: ["Skitty-Banerica"],
		formeOrder: ["Skitty", "Skitty-Banerica"],
	},
	skittybanerica: {
		num: 300,
		name: "Skitty-Banerica",
		types: ["Ghost"],
		forme: "Banerica",
		baseSpecies: "Skitty",
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 50, atk: 50, def: 45, spa: 40, spd: 35, spe: 55 },
		abilities: { 0: "Frisk", 1: "Contrary", H: "Cursed Body" },
		heightm: 0.6,
		weightkg: 11,
		color: "Purple",
		nfe: true,
		evos: ["Delcatty-Banerica"],
		eggGroups: ["Field", "Fairy"],
	},
	delcatty: {
		num: 301,
		...
		evoItem: "Moon Stone",
		eggGroups: ["Field", "Fairy"],
		otherFormes: ["Delcatty-Banerica"],
		formeOrder: ["Delcatty", "Delcatty-Banerica"]
	},
	delcattybanerica: {
		num: 301,
		name: "Delcatty-Banerica",
		types: ["Ghost"],
		forme: "Banerica",
		baseSpecies: "Delcatty",
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 75, atk: 70, def: 70, spa: 75, spd: 60, spe: 90 },
		abilities: { 0: "Frisk", 1: "Contrary", H: "Prankster" },
		heightm: 1.1,
		weightkg: 32.6,
		color: "Purple",
		prevo: "Skitty-Banerica",
		evoType: "useItem",
		evoItem: "Dusk Stone",
		eggGroups: ["Field", "Fairy"],
	},
...
//	},
	carvanha: {
		...
		abilities: { 0: "Predator", H: "Speed Boost" },
		heightm: 0.8,
		weightkg: 20.8,
		color: "Red",
		evos: ["Sharpedo"],
...
//	},
	wailmer: {
		...
		abilities: { 0: "Rain Dish", 1: "Oblivious", H: "Pressure" },
		heightm: 2,
		weightkg: 130,
		color: "Blue",
		evos: ["Wailord"],
	...
	numel: {
		...
		types: ["Ice", "Steel"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 60, atk: 60, def: 65, spa: 40, spd: 45, spe: 35 },
		abilities: { 0: "Snow Warning", 1: "Thick Fat", H: "Simple" },
		heightm: 0.7,
		weightkg: 30.0,
		color: "White",
		nfe: true,
...
//	},
	...
	spindabanerica: {
		num: 327,
		name: "Spinda-Banerica",
		types: ["Normal", "Ice"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 60, atk: 60, def: 60, spa: 60, spd: 60, spe: 60 },
		abilities: { 0: "Snow Cloak", 1: "Tangled Feet", H: "Contrary" },
		heightm: 1.1,
		weightkg: 5,
		color: "Blue",
		nfe: true,
...
//	},
	...
	altaria: {
		...
		name: "Altaria",
		types: ["Dragon", "Flying"],
		baseStats: { hp: 75, atk: 70, def: 90, spa: 70, spd: 105, spe: 90 },
		abilities: { 0: "Natural Cure", H: "Cloud Nine" },
		heightm: 1.1,
		weightkg: 20.6,
		color: "Blue",
...
//	},
	...
	chimecho: {
		...
		abilities: { 0: "Levitate", H: "Phantom Ward"  },
		heightm: 0.6,
		weightkg: 1,
		color: "Blue",
		prevo: "Chingling",
...
//	},
	...
	cherrim: {
		...
		baseForme: "Overcast",
		types: ["Grass"],
		baseStats: { hp: 70, atk: 90, def: 70, spa: 97, spd: 78, spe: 85 },
...
//	},
	maractus: {
		...
		name: "Maractus",
		types: ["Grass"],
		baseStats: { hp: 75, atk: 67, def: 67, spa: 120, spd: 86, spe: 60 },
...
//	},
	trubbish: {
		...
		abilities: { 0: "Stench", 1: "Sticky Hold", H: "Toxic Debris" },
		heightm: 0.6,
		weightkg: 31,
		color: "Green",
		evos: ["Garbodor"],
	...
	trubbishbanerica: {
		num: 568,
		name: "Trubbish-Banerica",
		baseSpecies: "Trubbish",
		forme: "Banerica",
		types: ["Water", "Poison"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 65, atk: 40, def: 62, spa: 50, spd: 62, spe: 50 },
		abilities: { 0: "Liquid Ooze", 1: "Weak Armor", H: "Toxic Debris" },
		heightm: 0.5,
		weightkg: 32.0,
		color: "Green",
		evos: ["Garbiathan"],
...
//	},
	shelmet: {
		...
		eggGroups: ["Bug"],
		isNonstandard: "Past",
		otherFormes: ["Shelmet-Banerica"],
		formeOrder: ["Shelmet", "Shelmet-Banerica"],
	},
	shelmetbanerica: {
		num: 616,
...
//	},
	...
	golettbanerica: {
		num: 2,
		name: "",
		baseSpecies: "Golett-Banerica",
		forme: "Banerica",
		types: ["Ground", "Fairy"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 59, atk: 64, def: 50, spa: 55, spd: 50, spe: 25 },
		abilities: { 0: "Iron Fist", 1: "Klutz", H: "Defiant" },
		heightm: 1.0,
		weightkg: 92.0,
		color: "Pink",
		evos: ["Golzerker"],
...
//	},
	...
	greedent: {
		...
		abilities: { 0: "Cheek Pouch", 1: "Unburden", H: "Gluttony" },
		heightm: 0.6,
		weightkg: 6,
		color: "Brown",
		prevo: "Skwovet",
...
//	},
	capsakid: {
		...
		evos: ["Scovillain"],
		eggGroups: ["Grass"],
		otherFormes: ["Capsakid-Banerica"],
		formeOrder: ["Capsakid", "Capsakid-Banerica"],
	},
	capsakidbanerica: {
		num: 951,
		...
		forme: "Banerica",
		types: ["Grass"],
		baseStats: { hp: 52, atk: 32, def: 48, spa: 68, spd: 48, spe: 58 },
		abilities: { 0: "Flame Body", 1: "Friend Guard", H: "Unaware" },
		heightm: 0.3,
		weightkg: 3,
		color: "Yellow",
		evos: ["Scovillain-Banerica"],
		nfe: true,
		eggGroups: ["Grass","Dragon"],
	},
	scovillain: {
	...
	scovillainbanerica: {
		...
		forme: "Banerica",
		types: ["Grass", "Fire"],
		baseStats: { hp: 65, atk: 60, def: 89, spa: 108, spd: 89, spe: 75 },
		abilities: { 0: "Flame Body", 1: "Friend Guard", H: "Unaware" },
		heightm: 0.9,
		weightkg: 15,
		color: "Yellow",
...
//	//Potassium 
	burpider: {
		...
		types: ["Bug", "Dark"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 46, atk: 55, def: 59, spa: 15, spd: 48, spe: 17 },
		abilities: { 0: "Shield Dust", 1: "Compound Eyes", H: "Pickpocket" },
		heightm: 0.5,
		weightkg: 9.1,
		color: "Black",
		...
		types: ["Bug", "Dark"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 60, atk: 92, def: 50, spa: 90, spd: 50, spe: 83 },
		...
		abilities: { 0: "Static", 1: "Natural Cure", H: "Hospitality" },
		heightm: 0.4,
		weightkg: 6.0,
		color: "Yellow",
		evos: ["Carontron"],
		...
		types: ["Ground", "Water"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 75, atk: 100, def: 90, spa: 50, spd: 75, spe: 60 },
		abilities: { 0: "Water Absorb", 1: "Flame Body" },
		heightm: 1.0,
		weightkg: 22.6,
		color: "Brown",
		...
		abilities: { 0: "Rattled", 1: "Chlorophyll", H: "Queenly Majesty" },
		heightm: 0.2,
		weightkg: 0.9,
		color: "Green",
		evos: ["Bittaroot", "Turnipoot"],
		nfe: true,
		eggGroups: ["Grass"],
	},
		bittaroot: {
		...
		types: ["Grass"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 73, atk: 57, def: 72, spa: 108, spd: 69, spe: 105 },
		abilities: { 0: "Rattled", 1: "Chlorophyll", H: "Queenly Majesty" },
		heightm: 1.2,
		weightkg: 54.9,
		color: "Green",
		...
		types: ["Rock", "Ground"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 30, atk: 65, def: 90, spa: 65, spd: 30, spe: 40 },
		abilities: { 0: "Rock Head", 1: "Sturdy", H: "Weak Armor" },
		heightm: 1.9,
		weightkg: 181.4,
		color: "Gray",
		...
		types: ["Steel", "Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 45, atk: 80, def: 68, spa: 35, spd: 68, spe: 29 },
		abilities: { 0: "No Guard" },
		heightm: 1.6,
		weightkg: 43.5,
		color: "Gray",
		...
		types: ["Steel", "Water"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 56, atk: 62, def: 82, spa: 55, spd: 75, spe: 25 },
		...
		types: ["Steel", "Water"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 86, atk: 90, def: 111, spa: 105, spd: 100, spe: 40 },
		abilities: { 0: "Analytic", 1: "Suction Cups", H: "Screen Cleaner" },
		heightm: 1.7,
		weightkg: 116.1,
		color: "Gray",
		...
		types: ["Grass"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 45, atk: 46, def: 65, spa: 87, spd: 60, spe: 50 },
		...
		types: ["Dark", "Flying"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 60, atk: 56, def: 56, spa: 68, spd: 75, spe: 90 },
		abilities: { 0: "Prankster", 1: "Unnerve", H: "Immunity" },
		heightm: 0.7,
		weightkg: 15.9,
		color: "Black",
		evos: ["Corvonic"],
		...
		abilities: { 0: "Curious Medicine", 1: "Unnerve", H: "Poison Heal" },
		heightm: 1.6,
		weightkg: 49.9,
		color: "Black",
		prevo: "Borvic",
		...
		types: ["Fire"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 85, atk: 45, def: 45, spa: 45, spd: 45, spe: 15 },
		...
		types: ["Fire"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 110, atk: 65, def: 65, spa: 65, spd: 65, spe: 20 },
		...
		abilities: { 0: "Truant", H: "Hydration" },
		heightm: 1.3,
		weightkg: 38.6,
		color: "Blue",
		evos: ["Nekocean"],
		...
		abilities: { 0: "Unaware", H: "Hydration" },
		heightm: 1.7,
		weightkg: 63.5,
		color: "Blue",
		prevo: "Marinyan",
		...
		abilities: { 0: "Slow Start", H: "Motor Drive" },
		heightm: 0.7,
		weightkg: 32.4,
		color: "Red",
		evos: ["Nautiwheel"],
		...
		abilities: { 0: "Speed Boost", H: "Motor Drive" },
		heightm: 1.2,
		weightkg: 999.9,
		color: "Red",
		prevo: "Jeepilus",
		...
		types: ["Ghost"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 29, atk: 92, def: 53, spa: 49, spd: 53, spe: 90 },
		...
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 49, atk: 127, def: 72, spa: 56, spd: 72, spe: 98 },
		...
		abilities: { 0: "Interference", 1: "Cute Charm", H: "Shadow Tag" },
		heightm: 1.2,
		weightkg: 33.4,
		color: "Black",
		evos: ["Gothinc"],
...
// Cankerwar Formes
		...
		evoLevel: 43,
		eggGroups: ["Monster", "Humanlike"],
		requiredItem: "Cheri Sugar",
		changesFrom: "Cankerwar",
	},
		cankerwarmokou: {
		num: 2090,
		name: "Cankerwar-Mokou",
		baseSpecies: "Cankerwar",
		forme: "Mokou",
		types: ["Fire", "Fighting"],
		genderRatio: { M: 0.0, F: 1.0 },
		...
		evoLevel: 43,
		eggGroups: ["Monster", "Humanlike"],
		requiredItem: "Rawst Sugar",
		changesFrom: "Cankerwar",
	},
		cankerwarcirno: {
		num: 2090,
		name: "Cankerwar-Cirno",
		baseSpecies: "Cankerwar",
		forme: "Cirno",
		types: ["Ice", "Fighting"],
		genderRatio: { M: 0.0, F: 1.0 },
		...
		evoLevel: 43,
		eggGroups: ["Monster", "Humanlike"],
		requiredItem: "Aspear Sugar",
		changesFrom: "Cankerwar",
	},
		cankerwaryakumo: {
		num: 2090,
		name: "Cankerwar-Yakumo",
		baseSpecies: "Cankerwar",
		forme: "Yakumo",
		types: ["Psychic", "Fighting"],
		genderRatio: { M: 0.0, F: 1.0 },
		...
		evoLevel: 43,
		eggGroups: ["Monster", "Humanlike"],
		requiredItem: "Chesto Sugar",
		changesFrom: "Cankerwar",
	},
		cankerwarmelancholy: {
		num: 2090,
		name: "Cankerwar-Melancholy",
		baseSpecies: "Cankerwar",
		forme: "Melancholy",
		types: ["Poison", "Fighting"],
		genderRatio: { M: 0.0, F: 1.0 },
	...
	cankerwarremilia: {
		...
		types: ["Fairy", "Fighting"],
		genderRatio: { M: 0.0, F: 1.0 },
		baseStats: { hp: 90, atk: 140, def: 90, spa: 65, spd: 93, spe: 92 },
		abilities: { 0: "Sturdy", 1: "Rocky Payload", H: "Sugar Rush" },
		heightm: 1.7,
		weightkg: 103.2,
		color: "Gray",
...
// Cankerwar Formes End
		...
		types: ["Grass", "Dragon"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 109, atk: 106, def: 100, spa: 93, spd: 103, spe: 39 },
	...
	platyplumphatbusted: {
		...
		abilities: { 0: "Dry Skin", 1: "Shed Skin", H: "Predator" },
		heightm: 0.2,
		weightkg: 1.2,
		color: "Yellow",
		evos: ["Gilltric"],
		...
		types: ["Ghost"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 54, atk: 70, def: 200, spa: 54, spd: 60, spe: 47 },
		abilities: { 0: "Cursed Body", H: "Cursed Marrow" },
		heightm: 1.6,
		weightkg: 14.4,
		color: "Black",
		...
		types: ["Dragon", "Normal"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 61, atk: 80, def: 65, spa: 74, spd: 70, spe: 70 },
		abilities: { 0: "Sticky Hold", H: "Intimidate"  },
		heightm: 1.3,
		weightkg: 16.5,
		color: "Blue",
		...
		types: ["Dragon", "Normal"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 90, atk: 80, def: 92, spa: 105, spd: 73, spe: 100 },
		abilities: { 0: "Sticky Hold", H: "Intimidate" },
		heightm: 2.2,
		weightkg: 210.0,
		color: "Brown",
		...
		types: ["Water", "Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 59, atk: 89, def: 54, spa: 50, spd: 51, spe: 79 },
		...
		weightkg: 14.7,
		color: "Green",
		evos: ["Barktic", "Howblazer", "Steerpaw"],
		nfe: true,
		eggGroups: ["Field"],
	},
		barktic: {
		...
		types: ["Water", "Psychic"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 63, atk: 35, def: 115, spa: 125, spd: 145, spe: 40 },
		abilities: { 0: "Trace", H: "Synchronize" },
		heightm: 1.0,
		weightkg: 30.0,
		color: "Yellow",
		...
		abilities: { 0: "Swift Swim", 1: "Flare Boost", H: "Alkaline" },
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
		evos: ["Kracket"],
		...
		abilities: { 0: "Liquid Ooze", 1: "Effect Spore", H: "Rivalry" },
		heightm: 1.1,
		weightkg: 29.6,
		color: "Gray",
		evos: ["Oryctaxite"],
		...
		types: ["Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 50, atk: 30, def: 64, spa: 60, spd: 75, spe: 59 },
		abilities: { 0: "Pickup", 1: "Slush Rush", H: "Pure Power" },
		heightm: 0.6,
		weightkg: 11.2,
		color: "White",
		evos: ["Astralagus"],
		...
		types: ["Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 58, atk: 50, def: 104, spa: 71, spd: 110, spe: 30 },
		abilities: { 0: "Power Spot", 1: "Slush Rush", H: "Pure Power" },
		heightm: 1,
		weightkg: 27,
		color: "White",
		nfe: true,
		...
		abilities: { 0: "Unnerve", 1: "Cursed Body", H: "Fluffy" },
		heightm: 0.1,
		weightkg: 0.1,
		color: "Black",
		evos: ["Goobearo"],
		...
		abilities: { 0: "Intimidate", 1: "Cursed Body", H: "Fluffy" },
		heightm: 0.1,
		weightkg:0.1,
		color: "Black",
		prevo: "Goobear",
		...
		abilities: { 0: "Sweet Veil", 1: "Caramellize", H: "Sticky Hold" },
		heightm: 1.4,
		weightkg: 89.0,
		color: "Pink",
		eggGroups: ["Dragon"],
		...
		types: ["Ghost", "Ice"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 72, atk: 127, def: 55, spa: 60, spd: 70, spe: 126 },
		...
		types: ["Grass", "Fire"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 71, atk: 73, def: 75, spa: 128, spd: 75, spe: 118 },
		...
		types: ["Ground", "Fairy"],
		gender: "N",
		baseStats: { hp: 104, atk: 124, def: 80, spa: 55, spd: 80, spe: 40 },
		abilities: { 0: "Iron Fist", 1: "Klutz", H: "Defiant" },
		heightm: 2.8,
		weightkg: 330.0,
		color: "White",
		...
		types: ["Ice"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 54, atk: 53, def: 59, spa: 43, spd: 62, spe: 35 },
		abilities: { 0: "Ice Body", 1:"Snow Warning", H: "Pressure" },
		heightm: 0.6,
		weightkg: 18.0,
		color: "Gray",
		evos: ["Sedimelt"],
		...
		types: ["Ice"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 75, atk: 82, def: 76, spa: 51, spd: 79, spe: 65 },
		abilities: { 0: "Ice Body", 1:"Snow Warning", H: "Pressure" },
		heightm: 1.2,
		weightkg: 98.0,
		color: "Gray",
		...
		types: ["Ice"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 100, atk: 112, def: 83, spa: 62, spd: 90, spe: 87 },
		abilities: { 0: "Ice Body", 1:"Snow Warning", H: "Pressure" },
		heightm: 1.9,
		weightkg: 188.0,
		color: "Gray",
		...
		name: "Lureel",
		types: ["Water", "Steel"],
		genderRatio: { M: 0.57, F: 0.43 },
		baseStats: { hp: 55, atk: 69, def: 63, spa: 48, spd: 44, spe: 61 },
		abilities: { 0: "Heavy Metal", 1: "Light Metal", H: "Rattled" },
		heightm: 0.1,
		weightkg: 0.58,
		color: "Blue",
		evos: ["Stymeel"],
		...
		types: ["Water", "Steel"],
		genderRatio: { M: 0.57, F: 0.43 },
		baseStats: { hp: 64, atk: 84, def: 104, spa: 74, spd: 94, spe: 30 },
		abilities: { 0: "Heavy Metal", 1: "Intimidate", H: "Predator" },
		heightm: 0.9,
		weightkg: 7.25,
		color: "Blue",
		prevo: "Lureel",
		...
		types: ["Water", "Steel"],
		genderRatio: { M: 0.57, F: 0.43 },
		baseStats: { hp: 150, atk: 136, def: 100, spa: 104, spd: 78, spe: 32 },
		abilities: { 0: "Heavy Metal", 1: "Intimidate", H: "Predator" },
		heightm: 18.0,
		weightkg: 720.0,
		color: "Black",
		...
		types: ["Water", "Poison"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 90, atk: 60, def: 82, spa: 95, spd: 82, spe: 65 },
		abilities: { 0: "Liquid Ooze", 1: "Weak Armor", H: "Toxic Debris" },
		heightm: 7.0,
		weightkg: 219.2,
		color: "Green",
		prevo: "Trubbish-Banerica",
		evoLevel: 36,
		eggGroups: ["Mineral", "Water 2"],
	},
		crustoctave: {
		...
		types: ["Water"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 40, atk: 54, def: 95, spa: 105, spd: 70, spe: 66 },
		abilities: { 0: "Hydration", 1: "Conductor", H: "Regenerator" },
		heightm: 0.5,
		weightkg: 20.4,
		color: "Red",
		evos: ["Coralstra"],
		...
		types: ["Water", "Fire"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 80, atk: 76, def: 114, spa: 122, spd: 88, spe: 50 },
		abilities: { 0: "Hydration", 1: "Conductor", H: "Regenerator" },
		heightm: 3.2,
		weightkg: 347.0,
		color: "Red",
		...
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 65, atk: 47, def: 45, spa: 72, spd: 47, spe: 88 },
		abilities: { 0: "Volt Absorb", 1: "Static", H: "Wind Power" },
		heightm: 0.8,
		weightkg: 20.0,
		color: "Yellow",
		evos: ["Dynaray"],
		...
		types: ["Flying", "Electric"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 102, atk: 68, def: 70, spa: 95, spd: 75, spe: 100 },
		abilities: { 0: "Volt Absorb", 1: "Static", H: "Wind Power" },
		heightm: 1.8,
		weightkg: 42.0,
		color: "Yellow",
		...
		types: ["Water"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 21, atk: 32, def: 43, spa: 51, spd: 33, spe: 80 },
		abilities: { 0: "Compound Eyes", 1: "Swift Swim", H: "Wimp Out" },
		heightm: 0.2,
		weightkg: 0.3,
		color: "Red",
		evos: ["Prawnxer"],
		...
		types: ["Water", "Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 40, atk: 101, def: 60, spa: 88, spd: 50, spe: 81 },
		abilities: { 0: "Compound Eyes", 1: "Swift Swim", H: "Iron Fist" },
		heightm: 0.5,
		weightkg: 7.8,
		color: "Red",
		prevo: "Weakrill",
		...
		types: ["Water", "Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 56, atk: 123, def: 70, spa: 98, spd: 65, spe: 88 },
		abilities: { 0: "Compound Eyes", 1: "Swift Swim", H: "Iron Fist" },
		heightm: 1.57,
		weightkg: 52.1,
		color: "Red",
		...
		types: ["Ice", "Steel"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 90, atk: 90, def: 105, spa: 50, spd: 100, spe: 20 },
		abilities: { 0: "Snow Warning", 1: "Thick Fat", H: "Stamina" },
		heightm: 1.98,
		weightkg: 354.0,
		color: "White",
		prevo: "Numel-Banerica",	
		evoLevel: 33,
		eggGroups: ["Field"],
	},
		spectrofin: {
		...
		types: ["Water", "Ghost"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 44, atk: 116, def: 67, spa: 94, spd: 89, spe: 100 },
		abilities: { 0: "Intimidate", 1: "Swift Swim", H: "Adaptability" },
		heightm: 1.55,
		weightkg: 47.2,
		color: "Purple",
		evos: ["Frilldeep"],
		...
		types: ["Dark", "Ghost"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 64, atk: 74, def: 96, spa: 100, spd: 101, spe: 75 },
		abilities: { 0: "Intimidate", 1: "Swift Swim", H: "Adaptability" },
		heightm: 3.8,
		weightkg: 98.0,
		color: "Purple",
		...
		types: ["Flying"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 46, atk: 58, def: 40, spa: 38, spd: 40, spe: 78 },
		abilities: { 0: "Cloud Nine", 1: "Early Bird", H: "Aerilate" },
		heightm: 0.7,
		weightkg: 1.2,
		color: "Blue",
		evos: ["Airret"],
		...
		types: ["Flying"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 65, atk: 94, def: 78, spa: 67, spd: 66, spe: 110 },
		abilities: { 0: "Cloud Nine", 1: "Early Bird", H: "Aerilate" },
		heightm: 1.8,
		weightkg: 2.6,
		color: "Blue",
		...
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 80, atk: 80, def: 80, spa: 80, spd: 80, spe: 80 },
		abilities: { 0: "Snow Cloak", 1: "Slush Rush", H: "Contrary" },
		heightm: 1.7,
		weightkg: 30.0,
		color: "Blue",
		prevo: "Spinda-Banerica",	
		evoLevel: 25,
		...
		abilities: { 0: "Radial Guard", 1: "Clear Body", H: "Shadow Shield" },
		heightm: 2.0,
		weightkg: 26.1,
		color: "Black",
		eggGroups: ["Flying"],
		...
		types: ["Bug", "Dark"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 32, atk: 76, def: 44, spa: 55, spd: 40, spe: 65 },
		abilities: { 0: "Wind Rider", 1: "Levitate", H: "Arena Trap" },
		heightm: 1.6,
		weightkg: 62.0,
		color: "Black",
		evos: ["Aracnimb"],
		...
		types: ["Bug", "Dark"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 76, atk: 115, def: 87, spa: 65, spd: 70, spe: 77 },
		abilities: { 0: "Wind Rider", 1: "Levitate", H: "Arena Trap" },
		heightm: 2.0,
		weightkg: 100.0,
		color: "Black",
		...
		types: ["Ground", "Normal"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 54, atk: 80, def: 66, spa: 70, spd: 81, spe: 53 },
		abilities: { 0: "Sand Rush", 1: "Sand Stream", H: "Wonder Skin" },
		heightm: 0.2,
		weightkg: 0.01,
		color: "Brown",
		evos: ["Dustinger"],
		...
		types: ["Ground", "Normal"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 76, atk: 102, def: 82, spa: 91, spd: 97, spe: 74 },
		abilities: { 0: "Sand Rush", 1: "Sand Stream", H: "Wonder Skin" },
		heightm: 2.0,
		weightkg: 59.0,
		color: "Brown",
...
// Scrapped/Event Mons
		...
		types: ["Grass", "Bug"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 77, atk: 130, def: 67, spa: 94, spd: 74, spe: 92 },
		abilities: { 0: "Overgrow", H: "Chlorophyll" },
		heightm: 4.2,
		weightkg: 51.7,
		color: "Red",
		...
		types: ["Ground"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 51, atk: 97, def: 78, spa: 40, spd: 48, spe: 81 },
		abilities: { 0: "Sand Rush", 1: "Sand Force", H: "Steelworker" },
		heightm: 1.2,
		weightkg: 36.0,
		color: "Yellow",
		evos: ["Perlithon"],
		...
		types: ["Ground"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 61, atk: 137, def: 98, spa: 48, spd: 55, spe: 91 },
		abilities: { 0: "Sand Rush", 1: "Sand Force", H: "Steelworker" },
		heightm: 3.6,
		weightkg: 72.0,
		color: "Yellow",
		...
		types: ["Grass"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 5, atk: 58, def: 40, spa: 53, spd: 45, spe: 105 },
		abilities: { 0: "Costar", 1: "Sturdy", H: "Dancer" },
		heightm: 0.01,
		weightkg: 0.02,
		color: "Green",
		evos: ["Pompalge"],
		eggGroups: ["Humanlike", "Water 1"],
	},
		pompalge: {
		num: 3007,
		name: "Pompalge",
		types: ["Grass", "Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 14, atk: 108, def: 60, spa: 103, spd: 65, spe: 125 },
		abilities: { 0: "Costar", 1: "Sturdy", H: "Dancer" },
		heightm: 0.03,
		weightkg: 0.1,
		color: "Green",
		...
		types: ["Ice", "Fire"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 65, atk: 91, def: 60, spa: 128, spd: 55, spe: 111 },
		abilities: { 0: "Vital Spirit", 1: "Competitive", H: "Friend Guard" },
		heightm: 1.6,
		weightkg: 55.0,
		color: "White",
		prevo: "Rolover",
		...
		types: ["Ice", "Fighting"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 68, atk: 121, def: 85, spa: 60, spd: 75, spe: 101 },
		abilities: { 0: "Vital Spirit", 1: "Defiant", H: "Stalwart" },
		heightm: 1.3,
		weightkg: 58.0,
		color: "White",
		prevo: "Rolover",
		...
		types: ["Steel", "Normal"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 53, atk: 89, def: 105, spa: 32, spd: 55, spe: 76 },
		abilities: { 0: "Cute Charm", 1: "Iron Barbs", H: "Run Away" },
		heightm: 0.3,
		weightkg: 19.0,
		color: "Black",
		evos: ["Opatchum"],
		...
		types: ["Steel", "Dark"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 77, atk: 104, def: 125, spa: 48, spd: 75, spe: 86 },
		abilities: { 0: "Intimidate", 1: "Iron Barbs", H: "Sharpness" },
		heightm: 1.0,
		weightkg: 71.0,
		color: "Black",
		prevo: "Pinchin",
	...
	//CMPB Winners
		gnalossus:{ //Trash Observer; First Tourney
		num: 4001,
		name: "Gnalossus",
		types: ["Flying", "Bug"],
		genderRatio: { M: 0.5, F: 0.5 },
		baseStats: { hp: 130, atk: 90, def: 83, spa: 84, spd: 80, spe: 58 },
		abilities: { 0: "Swarm", H: "Infested" },
		heightm: 15.5,
		weightkg: 355.0,
		color: "Blue",
		prevo: "Fleabat",

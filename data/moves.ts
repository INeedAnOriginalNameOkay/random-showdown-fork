...
// CMG Moves
	...
	awakenpowerbug: {
		...
		basePower: 80,
		category: "Special",
		realMove: "Awaken Power",
		//isNonstandard: "Past",
		name: "Awaken Power Bug",
		pp: 15,
		priority: 0,
		flags: { protect: 1, mirror: 1 },
		target: "normal",
	...
	*/
	...
	bassboost: {
		...
		basePower: 40,
		basePowerCallback(pokemon, target, move) {
			if (!pokemon.volatiles['bassboost'] || move.hit === 1) {
				pokemon.addVolatile('bassboost');
			}
			const bp = this.clampIntRange(move.basePower * pokemon.volatiles['bassboost'].multiplier, 1, 160);
			this.debug(`BP: ${bp}`);
			return bp;
		},
		category: "Special",
